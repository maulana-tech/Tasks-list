document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayAllTasks (tasks = existingTask){
        if(tasks.length === 0){
            ...
            console.log('beberapa task tersedian dan siap ditampilkan');

            tasks.forEach(task => {
                 
                const userDate = formatDate(task.createdAt);
                ...
                <div class="task-card flex flex-col gap-5">
                                <div class="flex gap-3 items-center">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <p class="text-sm leading-[21px] text-taskia-grey">Created at ${userDate}</p>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-row items-center gap-x-3">
                                <a href="#" id="deleteTask-${task.id}"
                                    ...
                                    ${task.isCompleted === false ?
                                        ...
                                        bg-gradient-to-b from-[#977FFF] to-[#6F4FFF] rounded-full w-full border border-taskia-background-grey">Complete</a>`
                ...
                itemTask.querySelector(`#completeTask-${task.id}`).addEventListener('click', function(event){
                    ...
                    const updateTask = myTask.getTask();
